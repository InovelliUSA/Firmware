Inovelli Blue Series MMWave Switch

<img width="290" height="548" alt="image" src="https://github.com/user-attachments/assets/03aad51b-4913-4816-a2cf-419b5d2c46fa" />


This is the repository for the Inovelli Blue Series MMWave Switch that houses all firmware files.

ABOUT Inovelli Blue Series MMWave Switch

SKU: VZM32-SN 

Changelog: Blue Series MMWave Switch Changelog 

Parameter Table: Blue Series MMWave Switch Parameter Table
...
DISCLAIMER The software is provided "as is" to provide our customers the ability to update our products.
...
BUGS / ENHANCEMENTS If you find a bug and would like to report it, please open a Bug Report and we will take a look at our earliest convenience. If you would like an enhancement, please open an Firmware Request and we will also take a look at our earliest convenience.
...
FIRMWARE CHANGELOG To view the changelog, please visit: https://community.inovelli.com/t/blue-series-mmwave-firmware-changelog-vzm32-sn/20869
